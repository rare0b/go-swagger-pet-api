...
import (
	...
	"restapi/operations"
	"restapi/operations/pet"
	"restapi/operations/store"
	"restapi/operations/user"
)

//go:generate swagger generate server --target ../../src --name Pet --spec ../swagger.json --principal interface{}
